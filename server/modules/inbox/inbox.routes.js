...
const uploadImage = require("../../shared/upload/upload.middleware");
...
router.delete("/music-feedback/delete/:id", inboxController.deleteMusicFeedback);
router.delete("/artwork-feedback/delete/:id", inboxController.deleteArtworkFeedback);
...
router.post("/upload-feedback-attachment", uploadImage.single("file"), inboxController.uploadFeedbackAttachment);
