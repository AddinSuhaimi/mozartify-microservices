...
import ArtsClerkSidebar from "./ArtsClerkSidebar";
import { API_BASE_URL} from './config/api.js';

const DRAWER_WIDTH = 230;

export default function ArtsClerkProfile() {
    ...
    <ThemeProvider theme={theme}>
      <Box sx={styles.root}>
        ...
        <Drawer variant="permanent" sx={styles.drawer} open>
          <ArtsClerkSidebar active="profile" />
        </Drawer>
                  ...
                  sx={{
                    ...
                    "& .MuiOutlinedInput-root": {
                      ...
                      "&.Mui-focused .MuiOutlinedInput-notchedOutline": {
                        borderColor: "#FFA0B3", // Darker border on focus
                      },
                    },
                  }}
                />
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              color: "#FFFFFF",
              backgroundColor:
                dialogConfig.confirmText === "DELETE" ? "#DB2226" : "#FFB6C1",
              border: `1px solid ${dialogConfig.confirmText === "DELETE" ? "#DB2226" : "#FFB6C1"}`,
              "&:hover": {
                backgroundColor:
                  dialogConfig.confirmText === "DELETE" ? "#B71C1C" : "#FFA0B3",
                borderColor:
                  dialogConfig.confirmText === "DELETE" ? "#B71C1C" : "#FFA0B3",
              },
            }}
