...
export default function CustomerProfile2() {
    ...
    <ThemeProvider theme={theme}>
      <Box sx={styles.root}>
        ...
        <Drawer variant="permanent" sx={styles.drawer} open>
          <CustomerSidebar2 active="profile" />
        </Drawer>
                ...
                <TextField
                  ...
                  sx={{
                    "& .MuiInputLabel-root.Mui-focused": {
                      color: "#FF9F8F", // Label color on focus
                    },
                    "& .MuiOutlinedInput-root": {
                      ...
                      "&:hover .MuiOutlinedInput-notchedOutline": {
                        borderColor: "#FF9F8F", // Darker border on hover
                      },
                      "&.Mui-focused .MuiOutlinedInput-notchedOutline": {
                        borderColor: "#FF9F8F", // Darker border on focus
                      },
                    },
                  }}
                />
