              ...
              >
                <InputBase
                  ...
                  placeholder={
                    isMobile
                      ? "Search..."
                      : "Look for your composed music scores here ..."
                  }
                  value={searchQuery}
            ...
            {loading ? (
              ...
              >
                ...
                >
                  ...
                  >
                    {composedScoresIDs.length > 99
                      ? "99+"
                      : composedScoresIDs.length}
                  </Box>{" "}
                  composed score(s) in total.
                </Typography>

                <Button
                  variant="contained"
                  component={Link}
                  to="customer-new-compose"
                  sx={{
                    bgcolor: "#8BD3E6", // Background color
                    color: "white", // Default text color
                    fontWeight: "bold",
                    fontFamily: "Montserrat",
                    textTransform: "none", // Keeps text formatting
                    boxShadow: "none", // Removes button shadow
                    "&:hover": {
                      bgcolor: "#6BB0C9", // Slightly darker hover effect
                      boxShadow: "none", // Removes button shadow
                    },
                  }}
                >
                  + Compose New Music Score
                </Button>
              </Box>
            )}
          </Box>
            ...
            <List>
              {currentItems.map((item) => (
                <ListItemButton
                  ...
                  onClick={() =>
                    navigate(
                      `/customer-compose/customer-music-score-view/${item._id}`
                    )
                  }
                  sx={{
