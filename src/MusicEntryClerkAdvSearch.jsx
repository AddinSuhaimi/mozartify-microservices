...
export default function MusicEntryClerkAdvSearch() {
  ...
  // Replace the hardcoded lists and add these state variables at the top of your ClerkSearch component:
                        ...
                        >
                          {paginatedResults.map((item) => (
                            <ListItemButton
                              ...
                              onClick={() =>
                                navigate(
                                  `/clerk-music-score-view/${item._id}`
                                )
                              }
                            >
                              <ListItemText
